    ...
    <section class="section">
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            <a href="/dataReg"><img src="../assets/img/smk2.png" alt="logo" width="80" class="shadow-light rounded-circle mb-5 mt-2"></a>
            <h4 class="text-dark font-weight-normal">Welcome to <span class="font-weight-bold">SMKN 2 Bandung</span></h4>
            ...
            <form method="POST" action="/logAuth" class="needs-validation" novalidate="">
              @csrf
              ...
              <div class="form-group">
                ...
                <input id="show_hide_password" type="password" class="form-control" name="password" tabindex="3" required>
                <div class="invalid-feedback">
              ...
              <div class="mt-5 text-center">
                Don't have an account? <a href="formulirReg">Create new one</a>
              </div>
            </form>
